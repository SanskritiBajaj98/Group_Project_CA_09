...
ggplot(tidy_GDP_subset_data, aes(x=Year, y = GDP_components, group = GDP_components)) +  geom_line()+  facet_wrap(~Country)+
labs (
    title = "GDP components over time", x="Year", y="Billion US$") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
