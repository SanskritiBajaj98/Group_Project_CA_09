...
new_table_2
p1<-ggplot(new_table_2, aes(x=Year, y = GDP_components, group = IndicatorNames, color = IndicatorNames)) +  
  facet_wrap(~Country)+
  geom_line()+
...
- What, if anything, gave you the most trouble: Graphs for few problems 
