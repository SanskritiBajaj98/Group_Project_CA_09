...
The data highlights that there is a 95% probability that the temperature will deviate from the avergae and that the deviation will lie between 5.6% to 10.2%, This highlights that there has been rise in temperature and the severity of the rise can differ. 
...
global_warming2 %>%
  count(party_or_ideology, response) #counting by reponse type to ensure that the unwanted responses have been omitted
